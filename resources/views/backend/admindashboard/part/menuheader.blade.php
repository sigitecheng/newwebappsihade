...
<div class="container-fluid">
    ...
    <!--Header-->
    <div class="row header shadow-sm" style="background: green ">
        ...
        <!--Logo-->
        <div class="col-sm-3 pl-0 text-center" style="background: green; height:60px;"> 
           <div class=" mr-3 mb-0 mt-10 mb-10 " style="display: flex; align-items: center; margin-bottom:10px">
           <img src="/assets/brosur/sihadetext.png" alt="Logo SIPJAKIKBB" style="margin-left:25px; margin-top:5px; width: 250px; height: 50px; object-fit: cover; margin-right: 10px; padding: 0;">
     ...
     <div class="marquee-container">
        <div class="marquee" style="color: black">Selamat Datang ! di Halaman Admin Sistem Sihade PT. Haznia Bina Virofarm </div>
    </div>
